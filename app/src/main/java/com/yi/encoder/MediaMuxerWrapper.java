...
public class MediaMuxerWrapper {
	...
	private static final String DIR_NAME = "FingerprintCamera";
...
//**********************************************************************
    ...
    public static final File getCaptureFile(final String type, final String ext) {
		...
		//final File dir = new File(Environment.getExternalStorageDirectory() + "/Android/data/" + type + "/" + DIR_NAME);
